...
<style>
	...
	.bx-filter.bx-wood .bx-ui-slider-handle.left{
		background: url('<?=DEFAULT_TEMPLATE_PATH?>/images/icon-left.png');
		background-repeat: no-repeat;
	}

	.bx-filter.bx-wood .bx-ui-slider-handle.right{
		background: url('<?=DEFAULT_TEMPLATE_PATH?>/images/icon-right.png');
		background-repeat: no-repeat;
	}
</style>

<div class="pakhi-filter bx-filter <?=$templateData["TEMPLATE_CLASS"]?> <?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL") echo "bx-filter-horizontal"?>">
				...
				<?foreach($arResult["ITEMS"] as $key=>$arItem)//prices
				{
					...
					if(isset($arItem["PRICE"])):
						...
						<div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-4<?else:?>col-lg-12<?endif?> bx-filter-parameters-box bx-active">
							...
							<div class="bx-filter-parameters-box-title" onclick="smartFilter.hideFilterProps(this)"><h3 class="m_2"><?=$arItem["NAME"]?> <i data-role="prop_angle" class="fa fa-angle-<?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>up<?else:?>down<?endif?>"></i></h3></div>
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					<div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-4<?else:?>col-lg-12<?endif?> bx-filter-parameters-box <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>bx-active<?endif?>">
						...
						<div class="bx-filter-parameters-box-title" onclick="smartFilter.hideFilterProps(this)">
							<h3 class="bx-filter-parameters-box-hint m_2"><?=$arItem["NAME"]?>
